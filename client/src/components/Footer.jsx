...
function Footer() {
	return (
		<footer className="bg-gray-900 text-white py-4 mt-10 rounded-t-2xl shadow-md">
			<div className="max-w-5xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center text-center md:text-left space-y-4 md:space-y-0">
